...
void NAND_Set8xTiming(void);

extern uint32  Bank_NAND_ADDR;

#define Bank2_NAND_ADDR    ((uint32_t)0x70000000)     
#define Bank3_NAND_ADDR    ((uint32_t)0x80000000)    

#define Select_NAND0         Bank_NAND_ADDR=Bank2_NAND_ADDR //选通Flash0
#define Select_NAND1         Bank_NAND_ADDR=Bank3_NAND_ADDR //选通Flash1
